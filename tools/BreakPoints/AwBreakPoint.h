...
public:
	...
	bool SetHWBreakPoint(BreakPoint*);
	bool ClearHWBreakPoint(BreakPoint*);

	bool SetINT3BreakPoint(BreakPoint*);
	bool ClearINT3BreakPoint(BreakPoint*);
...
private:
	...
	unsigned short MakeMask(DebugRegister reg);
	unsigned short MakeFlags(DebugRegister reg, BreakState state, BreakPointType cond, Size size);
};